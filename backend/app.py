...
class EmbeddingManager:
    def __init__(self, model_name: str = None):
        ...
        # Option 1: Try HuggingFace embeddings (good quality, local, preferred)
        try:
            ...
            logger.info(f"Using HuggingFace embeddings: {model_to_use}")
            return
        except Exception as e:
            logger.warning(f"Failed to initialize HuggingFace embeddings: {e}")
        
        # Option 2: Fallback to simple embeddings (functional but limited)
        logger.warning("Using fallback simple embeddings - performance will be limited")
